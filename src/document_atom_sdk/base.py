...
class BaseClient:
    """
    DocumentAtom SDK base client class.
    """
    ...
    def request(self, method: str, url: str, **kwargs):
        ...
        Args:
            ...
            **kwargs: Additional arguments to pass to the underlying httpx request.
                ...
                - content (bytes, optional): Raw content to send.
        ...
        if "headers" in kwargs:
            # If Content-Type is explicitly provided in headers, use it
            if "Content-Type" in kwargs["headers"]:
                headers["Content-Type"] = kwargs["headers"]["Content-Type"]
            headers.update(kwargs["headers"])
        # Don't set default Content-Type for multipart/form-data (file uploads)
        if "files" in kwargs:

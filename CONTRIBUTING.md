...
Welcome to `sdk-python` contributor's guide.
...
If you experience bugs or general issues with `sdk-python`, please have a look
...
You can help improve `sdk-python` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`sdk-python` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `sdk-python`'s files. While this mechanism can
...
```
conda create -n sdk-python python=3 six virtualenv pytest pytest-cov
conda activate sdk-python
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/sdk-python.git
   cd sdk-python
   ```
...
5. Install [pre-commit]:
   ...
   `sdk-python` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/sdk-python
[issue tracker]: https://github.com/<USERNAME>/sdk-python/issues
